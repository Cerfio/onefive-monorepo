...
function computeInitials(firstName?: string | null, lastName?: string | null): string | undefined {
...
export interface AvatarProps {
    ...
    initials?: string;
    /**
     * Convenience props: when `initials` is not provided, computed from
     * `firstName` + `lastName` (first character of each, uppercased).
     */
     ...
     */
    focusable?: boolean;
    /** App-specific variant hint (accepted but not styled by default). */
    variant?: string;
}
...
export const Avatar = ({
    ...
    const initials = initialsRaw ?? computeInitials(firstName, lastName);
