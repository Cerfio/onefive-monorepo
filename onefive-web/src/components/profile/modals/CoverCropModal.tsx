...
export const CoverCropModal = ({
  ...
  // Aspect ratio 3:1 pour cover (1200x400)
  const aspect = 3;
  ...
  const handleImageLoad = (e: SyntheticEvent<HTMLImageElement>) => {
    ...
    const crop = centerCrop(
      makeAspectCrop(
        {
          unit: "%",
          width: 90, // 90% de l'image pour une bonne couverture
        },
        aspect,
        width,
        height,
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Définir la taille finale de la cover (1200x400px)
          ...
          <div className="relative w-full overflow-hidden rounded-2xl bg-primary shadow-xl sm:max-w-5xl">
            ...
            <div className="flex gap-4 px-4 pt-5 sm:px-6 sm:pt-6">
              ...
              <div className="z-10 flex flex-col gap-0.5">
                <AriaHeading slot="title" className="text-md font-semibold text-primary">
                  Recadrer votre photo de couverture
                </AriaHeading>
                <p className="text-sm text-tertiary">
                  Ajustez votre image pour créer une couverture parfaite. Format 1200x400px.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-4 px-4 sm:px-6 md:gap-5">
              <Cropper
                ...
                className="h-48 w-full self-stretch sm:h-64"
              >
                <Cropper.Img
                  {...imageData}
              ...
              <div className="text-center">
                <p className="text-xs text-tertiary">
                  Déplacez et redimensionnez la zone de sélection pour ajuster votre couverture
                </p>
              </div>
            </div>
