  ...
  return (
    ...
    >
      ...
      <AriaInput
        ...
        className={cx(
          'ph-no-capture m-0 w-full bg-transparent text-md text-primary ring-0 outline-hidden placeholder:text-placeholder autofill:rounded-lg autofill:text-primary',
