...
const withPillTypes = {
    [badgeTypes.pillColor]: {
        common: "size-max flex items-center whitespace-nowrap rounded-full",
        styles: filledColors,
    },
    [badgeTypes.badgeColor]: {
        common: "size-max flex items-center whitespace-nowrap rounded-md",
        styles: filledColors,
    },
    [badgeTypes.badgeModern]: {
        ...
        styles: {
            gray: {
                root: "bg-primary text-secondary",
                addon: "text-gray-500",
                addonButton: "hover:bg-utility-gray-100 text-utility-gray-400 hover:text-utility-gray-500",
            },
        },
...
const withBadgeTypes = {
    ...
    [badgeTypes.badgeModern]: {
        common: "size-max flex items-center whitespace-nowrap rounded-md bg-primary text-secondary shadow-xs",
