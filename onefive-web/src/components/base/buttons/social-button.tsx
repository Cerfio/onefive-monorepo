...
export const styles = sortCx({
  ...
  colors: {
    ...
    linkedin: {
      root: 'bg-[#0077B5] text-white shadow-xs-skeumorphic ring-1 ring-transparent ring-inset before:absolute before:inset-px before:border before:border-white/12 before:mask-b-from-0% hover:bg-[#005885]',
      icon: '',
    },
  },
});
...
interface CommonProps {
  social: 'google' | 'facebook' | 'apple' | 'twitter' | 'figma' | 'dribble' | 'linkedin';
  disabled?: boolean;
      ...
      <Logo
        className={cx(
          ...
          theme === 'gray'
            ? colorStyles.icon
            : theme === 'brand' &&
                (social === 'facebook' || social === 'apple' || social === 'twitter' || social === 'linkedin')
              ? 'text-white'
