...
export const Popover = (props: PopoverProps) => {
    return (
        <AriaPopover
            ...
            className={(state) =>
                cx(
                    "max-h-64! w-(--trigger-width) overflow-x-hidden overflow-y-auto rounded-lg bg-primary py-1 shadow-lg ring-1 ring-secondary_alt outline-hidden will-change-transform z-[100] pointer-events-auto",
