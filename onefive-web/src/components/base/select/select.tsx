                    ...
                    return (
                        <>
                            {state.selectedItem?.avatarUrl ? (
                                <Avatar size="xs" src={state.selectedItem.avatarUrl} alt={state.selectedItem.label} shape="square" />
                            ) : (state.selectedItem?.firstName || state.selectedItem?.lastName || state.selectedItem?.initials) ? (
                                <Avatar 
                                    size="xs" 
                                    firstName={state.selectedItem.firstName}
                                    lastName={state.selectedItem.lastName}
                                    initials={state.selectedItem.initials}
