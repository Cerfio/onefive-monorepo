...
export const SelectItem = ({ label, id, value, avatarUrl, firstName, lastName, initials, supportingText, isDisabled, icon: Icon, className, children, ...props }: SelectItemProps) => {
    ...
    return (
        ...
        >
            {(state) => (
                ...
                >
                    {avatarUrl ? (
                        <Avatar aria-hidden="true" size="xs" src={avatarUrl} alt={label} shape="square" />
