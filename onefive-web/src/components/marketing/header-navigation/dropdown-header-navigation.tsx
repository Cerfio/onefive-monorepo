        ...
        <div className="px-3 pb-2 md:max-w-84 md:p-0">
            <nav className="overflow-hidden rounded-xl bg-secondary shadow-xs ring-1 ring-secondary_alt md:rounded-2xl md:shadow-lg">
                ...
                <div className="px-4 py-5 text-center sm:px-5">
                    <Button href="/resources" color="link-color" size="lg">
                        All resources
                    </Button>
                </div>
            </nav>
                    ...
                    <FeatureCardVertical
                        ...
                        actionsContent={
                            <div className="inline-flex gap-3">
                                ...
                                <Button color="link-color" size="sm" href="/changelog">
                                    Changelog
                                </Button>
                            </div>
                        }
        ...
        <div className="px-3 pb-2 md:max-w-200 md:p-0">
            <nav className="overflow-hidden rounded-xl bg-secondary shadow-xs ring-1 ring-secondary_alt md:rounded-2xl md:shadow-lg">
                    ...
                    <div className="flex flex-col gap-5 md:flex-row md:gap-8 md:py-0">
                        <div className="-mb-px flex flex-col gap-4 border-b border-b-secondary px-4 pb-5 md:mb-0 md:gap-5 md:border-none md:p-0">
                            ...
                            <ul className="flex flex-col gap-3">
                                {[
                                    { title: "Setup 101", href: "/docs/setup" },
                                    { title: "Adding users", href: "/docs/users" },
                                    { title: "Video tutorials", href: "/tutorials" },
                                    { title: "Libraries and SDKs", href: "/docs/sdks" },
                                    { title: "Adding plugins", href: "/docs/plugins" },
                                    { title: "Dashboard templates", href: "/docs/templates" },
                                ].map((item) => (
                                    <li key={item.title}>
                ...
                <div className="mx-auto flex max-w-container flex-col px-4 py-5 md:flex-row md:items-center md:justify-between md:px-6">
                    <Button href="/docs" color="secondary" size="md" iconLeading={BookOpen01} className="hidden md:flex">
                        Documentation
                    </Button>
                    <Button href="/resources" color="primary" size="md" className="hidden md:flex">
                        View all resources
                    </Button>
                    <Button href="/resources" color="primary" size="sm" className="md:hidden">
                        View all resources
                    </Button>
                </div>
            </nav>
