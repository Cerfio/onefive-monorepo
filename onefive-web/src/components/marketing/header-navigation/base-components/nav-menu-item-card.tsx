...
export const ImageCardHorizontal = (props: ImageCardProps & { href?: string }) => {
    return (
        <a
            href={props.href || "/"}
...
export const ImageCardVertical = (props: ImageCardProps & { href?: string }) => {
    return (
        <a
            href={props.href || "/"}
...
export const VideoCardHorizontal = (props: VideoCardProps & { href?: string }) => {
    return (
        <a
            href={props.href || "/"}
            className="flex flex-col gap-4 rounded-lg px-4 py-3 outline-focus-ring transition hover:bg-primary_hover focus-visible:outline-2 sm:flex-row md:gap-3 md:px-3"
...
export const VideoCardVertical = (props: VideoCardProps & { href?: string }) => {
    return (
        <a
            href={props.href || "/"}
