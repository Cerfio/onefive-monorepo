...
const JobCardNaked = (props: JobCardNakedProps) => {
    return (
        <a
            href={props.href}
            className="-mt-px flex flex-col rounded-sm border-t border-brand_alt pt-6 outline-focus-ring transition duration-100 ease-linear focus-visible:outline-2 focus-visible:outline-offset-4"
        >
