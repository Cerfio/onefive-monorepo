...
import { type Article, Simple01Vertical } from "./base-components/blog-cards";
        ...
        <div className="bg-primary">
            ...
            <main className="mx-auto flex w-full max-w-container flex-col gap-12 px-4 pb-16 md:gap-16 md:px-8 md:pb-24">
                <a
                    ...
                    className="relative hidden w-full overflow-hidden rounded-2xl outline-focus-ring focus-visible:outline-2 focus-visible:outline-offset-4 md:block md:h-145 lg:h-180"
                >
                                ...
                                <div className="flex flex-1 gap-8">
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <a
                                            ...
                                            className="flex items-center gap-2 rounded-sm outline-fg-white focus-visible:outline-2 focus-visible:outline-offset-4"
                                        >
                                    ...
                                    <ul className="flex h-10 items-center gap-2">
                                        {featuredArticle.tags.map((tag) => (
                                            <li key={tag.name}>
                                                <a
                                                    href={tag.href}
                                                    className="flex rounded-full outline-fg-white focus-visible:outline-2 focus-visible:outline-offset-4"
                                                >
                                                    <span className="rounded-full bg-transparent px-2 py-0.5 text-xs font-medium text-fg-white ring-1 ring-fg-white ring-inset">
                                                        {tag.name}
                                                    </span>
                                                </a>
                                            </li>
