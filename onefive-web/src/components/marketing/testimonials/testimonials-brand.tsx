                    ...
                    <figure className="flex max-w-270 flex-col gap-8 text-center">
                        <AnimatePresence initial={false} mode="popLayout">
                            <motion.blockquote
                                ...
                                className="origin-bottom text-display-sm font-medium text-balance text-primary_on-brand will-change-transform md:text-display-md"
                            >
                            ...
                            >
                                <div className="flex flex-col items-center gap-4">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        <p className="text-lg font-semibold text-primary_on-brand">{reviews[currentReviewIndex].author.name}</p>
                                        <cite className="text-md text-tertiary_on-brand not-italic">{reviews[currentReviewIndex].author.title}</cite>
                                    </div>
                                </div>
