    ...
    return (
        <div className={cx("flex w-full flex-col items-center justify-center gap-4", size === "sm" && "gap-3")}>
            <div className="relative flex w-full flex-col items-center self-stretch">
                ...
                {connector && (
                    <span className={cx("absolute top-1/2 left-[53%] z-0 w-full flex-1 -translate-y-1/2 rounded-sm border-t-2", statuses[status].connector)} />
                )}
            </div>
    ...
    return (
        <div className={cx("group flex h-max flex-row items-start justify-start gap-4", size === "sm" && "gap-3")}>
            <div className="flex flex-col items-center self-stretch">
                <IconOnly {...otherProps} size={size} status={status} />
                {connector && <span className={cx("flex-1 rounded-sm border-l-2", statuses[status].connector, size === "sm" ? "my-1" : "my-1.5")} />}
            </div>
        ...
        <div className={cx("flex w-full flex-col items-center justify-center gap-4", size === "sm" && "gap-3")}>
            <div className={cx("relative flex w-full flex-col items-center self-stretch")}>
                ...
                {connector && (
                    <span
                        className={cx(
                            "absolute top-1/2 left-[53%] z-0 w-full flex-1 -translate-y-1/2 rounded-sm border-t-2 border-secondary",
    ...
    return (
        <div className={cx("group flex flex-row gap-4", status !== "current" && "opacity-60", size === "sm" && "gap-3")}>
            <div className="flex flex-col items-center self-stretch">
                ...
                {connector && <span className={cx(status === "current" && "opacity-60", "my-1 flex-1 rounded-sm border-l-2 border-secondary")} />}
            </div>
